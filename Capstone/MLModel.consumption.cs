...
namespace Capstone
{
    public partial class MLModel
    {
        ...
        public class ModelInput
        {
            ...
            public float Overall_Pax_Amount { get; set; }
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"Overall_Pax_Amount_LB")]
            public float[] Overall_Pax_Amount_LB { get; set; }

            [ColumnName(@"Overall_Pax_Amount_UB")]
            public float[] Overall_Pax_Amount_UB { get; set; }

        }

        #endregion

        private static string MLNetModelPath = Path.GetFullPath(@"C:\Users\Tine Cacapit\source\repos\WiibandSystem1\Capstone\MLModel.mlnet");
