...
namespace Capstone
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\Tine Cacapit\source\repos\WiibandSystem1\Capstone\Dataset.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Forecasting.ForecastBySsa(windowSize:70,seriesLength:2147,trainSize:3018,horizon:10,outputColumnName:@"Overall_Pax_Amount",inputColumnName:@"Overall_Pax_Amount",confidenceLowerBoundColumn:@"Overall_Pax_Amount_LB",confidenceUpperBoundColumn:@"Overall_Pax_Amount_UB");
